                    ...
                    <div className="row full-height justify-content-center">
                        <div className="col-12 text-center align-self-center py-5">
                            <div className="section pb-5 pt-5 pt-sm-2 text-center">
                                <h6 className="mb-0 pb-3"><span>Log In </span><span>Registrati</span></h6>
                                            ...
                                            <div className="center-wrap">
                                                <div className="section text-center">
                                                    ...
                                                    <form onSubmit={handleLogin}>
                                                        ...
                                                        <button className="btn mt-4" type="submit">Accedi</button>
                                                    </form>
                                                    {status && <p className="mt-4 text-center">{status}</p>}
                                                    <p className="mb-0 mt-4 text-center"><a href="" className="link">Hai dimenticato la password?</a></p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="center-wrap ">
                                                <div className="section text-center">
                                                    ...
                                                    <form onSubmit={handleRegister}>
                                                        ...
                                                        <button className="btn mt-4" type="submit">Registrati</button>
                                                    </form>
                                                    {status && <p className="mt-4 text-center">{status}</p>}
                                                </div>
                                            </div>
