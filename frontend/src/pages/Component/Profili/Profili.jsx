...
import ProfiloUR from './ProfileUR';
import ProfiloCISO from './ProfiloCISO';
import ProfiloAS from './ProfiloAS';
...
function Profili({ token, ruolo }) {
  ...
  switch (ruolo) {
    case 'Utente':
      return <ProfiloUR token={token} renderDettagliProfilo={() => renderDettagliProfilo(profilo)} />;
    case 'CISO':
      return <ProfiloCISO token={token} renderDettagliProfilo={() => renderDettagliProfilo(profilo)} />;
    case 'Amministratore di sistema':
      return <ProfiloAS token={token} renderDettagliProfilo={() => renderDettagliProfilo(profilo)} />;
    default:
