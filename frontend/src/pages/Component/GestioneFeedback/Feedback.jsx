...
function Feedback({ token }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault(); // Impedisce il comportamento predefinito del form di ricaricare la pagina
    if (!validateForm()) {
      return;
    }
    try {
    ...
    <div className="max-w-5xl mx-auto mt-16 px-4 sm:px-6 lg:px-8">
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="p-6 sm:p-8">
          ...
          {!formSubmitted && ( // Mostra il form solo se non è stato inviato con successo
